...
export default function AddBudgetModal({ isOpen, onClose, onSuccess }: AddBudgetModalProps) {
  ...
  return (
    <div className="w-full animate-slide-up">
      <div className="card p-4 md:p-6 border-2 border-purple-500/50 bg-gradient-to-br from-slate-800/95 to-slate-900/95 w-full max-w-2xl mx-auto">
        <div className="border-b border-slate-700 pb-4 mb-4 flex justify-between items-center">
          <h2 className="text-xl md:text-2xl font-bold text-white">Create Budget</h2>
          <button
            onClick={onClose}
