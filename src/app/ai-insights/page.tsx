    ...
    <div className="min-h-screen bg-gray-950 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Get personalized financial recommendations powered by AI</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-800 rounded-lg p-6">
            <h3 className="text-lg font-bold text-white mb-4">Select Insight Type</h3>
              ...
              {[
                ...
                <button
                  ...
                  className={`w-full p-3 rounded-lg text-left transition-colors ${
                    selectedInsightType === option.value
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full mt-6 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium disabled:opacity-50"
            >
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-700 rounded p-3">
                ...
                <p className="text-xl font-bold text-blue-400">{analytics.savingsRate}%</p>
              </div>
              <div className="bg-gray-700 rounded p-3">
                <p className="text-xs text-gray-400">Net Cash Flow</p>
                <p className={`text-xl font-bold ${analytics.netCashFlow >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        {recommendations.length > 0 && (
          <div className="bg-gray-800 rounded-lg p-6 mb-8">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-white">Generated Insights</h3>
              <button
        ...
        <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-lg p-6">
          <h3 className="text-lg font-bold text-white mb-4">💡 AI Tips for Better Financial Health</h3>
