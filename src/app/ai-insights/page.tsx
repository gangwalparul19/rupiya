  ...
  return (
    <PageWrapper>
      <div className="py-4 sm:py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-block">
          <div className="card">
          ...
          {/* Financial Overview */}
          <div className="card">
            <h3 className="heading-section mb-6">Financial Overview</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-4">
                <p className="text-xs text-slate-400 font-medium mb-1">Total Expenses</p>
              ...
              <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-4">
                <p className="text-xs text-slate-400 font-medium mb-1">Net Cash Flow</p>
